...
for i in $SAMPLES; do
samtools faidx refgenome/GCF_014633375.1_OchPri4.0_genomic.fna -r coordinates/plus/XM_004578932.1_coord.txt | bcftools consensus -s "$i" 45_norm_dp4_renamed.vcf.gz -I -M "N" > nuc_fasta/plus/XM_004578932.1/"$i"_XM-004578932.1.fa
done
